...
rawdata <- bind_rows(lapply(list.files(path="data_inlab/",pattern="trial",full.names=T), read_csv))
qdata <- bind_rows(lapply(list.files(path="data_inlab/",pattern="qu",full.names=T), read_csv))
